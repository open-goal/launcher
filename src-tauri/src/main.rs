...
fn main() {
  ...
  let tauri_setup = tauri::Builder::default()
    ...
    .invoke_handler(tauri::generate_handler![
      ...
      commands::config::get_jak1_movie_directory,
      commands::config::get_jak2_movie_directory,
      ...
      commands::config::set_jak1_movie_directory,
      commands::config::set_jak2_movie_directory,
