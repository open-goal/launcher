...
fn main() {
  ...
  let tauri_setup = tauri::Builder::default()
    ...
    .invoke_handler(tauri::generate_handler![
      ...
      commands::config::find_gamescope_binary,
      commands::config::get_gamescope_binary,
      commands::config::set_gamescope_binary,
      commands::config::is_gamescope_enabled,
      commands::config::set_gamescope_enabled,
      commands::config::is_mangohud_enabled,
      commands::config::set_mangohud_enabled,
      commands::config::set_window_type,
      commands::config::get_window_type,
      commands::config::get_window_width,
      commands::config::set_window_width,
      commands::config::get_window_height,
      commands::config::set_window_height,
      commands::config::set_upscale_enabled,
      commands::config::is_upscale_enabled,
      commands::config::get_upscale_width,
      commands::config::get_upscale_height,
      commands::config::set_upscale_width,
      commands::config::set_upscale_height,
      commands::config::set_upscale_method,
      commands::config::get_upscale_method,
      commands::config::is_hdr_enabled,
      commands::config::set_hdr_enabled,
