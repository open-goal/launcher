import { extractAndValidateISO, runDecompiler, runCompiler, updateDataDirectory } from "$lib/rpc/binaries";
...
export async function setupInstallGame(activeGame: SupportedGame, sourcePath: string) {
