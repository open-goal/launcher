...
import { baseGameIsoExists, extractIsoForModInstall, decompileForModInstall, compileForModInstall, saveModInstallInfo, downloadAndExtractNewMod } from "$lib/rpc/features";
...
export async function setupModInstallation(activeGame: SupportedGame, modName: string, modSourceName: string, modDownloadUrl: string | undefined, modVersion: string) {
    jobTracker.init([
        {
            status: "queued",
...
export async function setupDecompileModJob(activeGame: SupportedGame, modName: string, modSourceName: string) {
...
export async function setupCompileModJob(activeGame: SupportedGame, modName: string, modSourceName: string) {
    // Check to see if we need to prompt for the ISO or not
    jobTracker.init([
        {
            status: "queued",
